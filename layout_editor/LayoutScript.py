...
class drc:
    ...
    def addViolationGraphical(self, p: pointArray) -> None:
        return _LayoutScript.drc_addViolationGraphical(self, p)

    def angle45OnLayer(self, layer: int, mergeBefore: bool = False) -> None:
        return _LayoutScript.drc_angle45OnLayer(self, layer, mergeBefore)

    def angle90OnLayer(self, layer: int, mergeBefore: bool = False) -> None:
        return _LayoutScript.drc_angle90OnLayer(self, layer, mergeBefore)

    def circleRadiusOnLayer(self, min: int, max: int, layer: int) -> None:
        return _LayoutScript.drc_circleRadiusOnLayer(self, min, max, layer)

    def clearDRC(self) -> None:
        return _LayoutScript.drc_clearDRC(self)

    def clearViolationView(self) -> None:
        return _LayoutScript.drc_clearViolationView(self)

    def densityOnLayer(self, layer: int, box: int, min: float, max: float) -> None:
    ...
    def loadViolationList(self, filename: str) -> None:
        return _LayoutScript.drc_loadViolationList(self, filename)

    def maximizeViolationView(self) -> None:
        return _LayoutScript.drc_maximizeViolationView(self)

    def maximumAngleOnLayer(
        self, anglevalue: float, layer: int, mergeBefore: bool = False
    ) -> None:
        return _LayoutScript.drc_maximumAngleOnLayer(
            self, anglevalue, layer, mergeBefore
        )

    def maximumAreaOnLayer(
        self, layer: int, areavalue: float, mergeBefore: bool = False
    ) -> None:
        return _LayoutScript.drc_maximumAreaOnLayer(self, layer, areavalue, mergeBefore)

    def maximumDimensionOnLayer(
        self, length: int, width: int, layer: int, mergeBefore: bool = False
    ) -> None:
    ...
    def maximumDistance(self, distance: int, layer1: int, layer2: int) -> None:
        return _LayoutScript.drc_maximumDistance(self, distance, layer1, layer2)

    def maximumInaccessibilityOnLayer(
        self, layer: int, inaccessibility: int, mergeBefore: bool = False
    ) -> None:
    ...
    def maximumPerimeterOnLayer(
        self, layer: int, perimeter: int, mergeBefore: bool = False
    ) -> None:
        return _LayoutScript.drc_maximumPerimeterOnLayer(
            self, layer, perimeter, mergeBefore
        )

    def minimumAngleOnLayer(
        self, anglevalue: float, layer: int, mergeBefore: bool = False
    ) -> None:
    ...
    def minimumDistance(self, distance: int, layer1: int, layer2: int) -> None:
        return _LayoutScript.drc_minimumDistance(self, distance, layer1, layer2)

    def minimumDistanceOrOverlap(
        self, distance: int, layer1: int, layer2: int, mode: bool = True
    ) -> None:
        return _LayoutScript.drc_minimumDistanceOrOverlap(
            self, distance, layer1, layer2, mode
        )

    def minimumEdgeLengthOnLayer(self, edgeSize: int, layer: int) -> None:
        return _LayoutScript.drc_minimumEdgeLengthOnLayer(self, edgeSize, layer)

    def minimumElementDistance(
        self, distance: int, layer: int, mergeBefore: bool = False
    ) -> None:
        return _LayoutScript.drc_minimumElementDistance(
            self, distance, layer, mergeBefore
        )

    def minimumElementDistanceOnActiveLayer(self, distance: int) -> None:
        return _LayoutScript.drc_minimumElementDistanceOnActiveLayer(self, distance)

    def minimumEnclosure(self, distance: int, layer1: int, layer2: int) -> None:
        return _LayoutScript.drc_minimumEnclosure(self, distance, layer1, layer2)

    def minimumInaccessibilityOnLayer(
        self, layer: int, inaccessibility: int, mergeBefore: bool = False
    ) -> None:
    ...
    def minimumNotchOnLayer(
        self,
        notchsize: int,
        layer: int,
        mergeBefore: bool = False,
        testSlots: bool = False,
    ) -> None:
        return _LayoutScript.drc_minimumNotchOnLayer(
            self, notchsize, layer, mergeBefore, testSlots
        )

    def minimumOverlap(self, overlap: int, layer1: int, layer2: int) -> None:
        return _LayoutScript.drc_minimumOverlap(self, overlap, layer1, layer2)

    def minimumOverlapDistance(self, distance: int, layer1: int, layer2: int) -> None:
        return _LayoutScript.drc_minimumOverlapDistance(self, distance, layer1, layer2)

    def minimumPerimeterOnLayer(
        self, layer: int, perimetervalue: int, mergeBefore: bool = False
    ) -> None:
